...
namespace cppcgen {
    ...
    static inline std::string to_string(int a) {
        std::stringstream s;
        s << a;
        return s.str();
    }   

    static inline int from_string(const std::string &s) {
        return atoi(s.c_str());
    }   
    ...
    static inline void Insert(std::string &str, const std::string &s, size_t pos) { 
        str.insert(pos, s); 
    }
    ...
    static inline size_t Split(const std::string &str, const std::string &delim, 
